# ns2d_tgv_pinn_rebuild_outputs.py
# Rebuilt vanilla PINN for 2D incompressible Navier-Stokes Taylor-Green MMS benchmark.
# Main purpose:
...
class BaselineModel(nn.Module):
    """
    Vanilla feedforward PINN baseline.

    The model is a standard fully connected MLP mapping (x, y, t) to
    (u, v, p). It contains no recurrent, attention, decomposition, or
    causal weighting module, so it serves as the basic reference baseline
    for the TGV comparison group.
    """
