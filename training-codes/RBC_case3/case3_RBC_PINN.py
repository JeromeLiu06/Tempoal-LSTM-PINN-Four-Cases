# ns2d_rbc_pinn_rebuild_outputs.py
# Rebuilt PINN training code for 2D Rayleigh-Benard Convection MMS benchmark
...
def write_model_info(cfg: RBCConfig, model: nn.Module, trainable_params: int, total_params: int):
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        f.write("Architecture: fully connected PINN / MLP\n")
