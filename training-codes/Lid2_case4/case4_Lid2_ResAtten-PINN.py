...
SOURCE_CASE2_FILE = "ns2d_cavity_reatten_pinn_rebuild_outputs (1).py"
...
class CavityConfig:
    ...
    # Exact Case2 residual-attention settings.
    hidden: int = 128
    ...
    out_dir: str = "./outputs/Case4-Lid2-Re100/ResAtten-PINN"
    seed: int = 0
...
def save_model_info(cfg: CavityConfig, model: nn.Module) -> None:
    with open(os.path.join(cfg.out_dir, "model_info.txt"), "w", encoding="utf-8") as handle:
        ...
        handle.write("Architecture: Residual-attention PINN; hidden=128; residual_attention_blocks=8; tanh features; sigmoid gates\n")
