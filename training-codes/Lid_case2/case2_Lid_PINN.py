# ns2d_cavity_pinn_rebuild_outputs.py
# Rebuilt vanilla PINN for 2D incompressible Navier-Stokes lid-driven cavity MMS benchmark.
# Main purpose:
...
class CavityConfig:
    ...
    # Vanilla PINN architecture. Keep this aligned with the TGV PINN baseline.
    hidden: int = 128
...
class BaselineModel(nn.Module):
    """Vanilla fully connected PINN baseline for the lid-driven cavity case."""
