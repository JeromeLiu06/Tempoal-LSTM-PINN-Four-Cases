...
class CavityConfig:
    ...
    # Output
    out_dir: str = "./outputs/Lid/DP-PINN"
    seed: int = 0
...
class RecursiveOperatorBlock(nn.Module):
    ...
    The same nonlinear operator is repeatedly applied to a latent state.
    This gives the baseline a recursive/shared-operator structure while
    keeping the training data, optimizer, loss terms, and output protocol
    identical to the other Lid-driven cavity models.
    """
